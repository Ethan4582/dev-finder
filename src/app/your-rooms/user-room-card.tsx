...
export default function UserRoomCard({ room }: { room: Room }) {
  ...
  <Button
    ...
    variant="ghost"
    size="icon"
    className="absolute top-1 right-1  bg-white hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 shadow-sm"
  >
    <Link href={`/edit-room/${room.id}`} aria-label="Edit Room">
